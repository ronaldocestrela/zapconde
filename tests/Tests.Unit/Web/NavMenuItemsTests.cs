...
{
    [Theory]
    [InlineData(SmartCondoRoles.Sindico, new[] { "Início", "Unidades e Moradores", "Financeiro", "Operações", "Portaria", "WhatsApp / IA", "Configurações" })]
    [InlineData(SmartCondoRoles.Administradora, new[] { "Início", "Unidades e Moradores", "Financeiro", "Operações", "Portaria", "WhatsApp / IA", "Configurações" })]
    [InlineData(SmartCondoRoles.Condomino, new[] { "Início", "Financeiro", "Operações", "Portaria", "Configurações" })]
